...
int main(int argc, char **argv)
{
        ...
        for(j=rank*spr;j<(rank+1)*spr;j++){
                ...
                sprintf(NAME1,"./traj_data/dump10000/dump10000_N%dtaur%.4fv%.4lfl%ddt%.4fF%.4f_%d.xyz",N,1.0/gammar,v,legs,dt,F,j);
                ofp1=fopen(NAME1,"w");
                                
                                
                for(t=1;t<T1+plustime+1;t++){
